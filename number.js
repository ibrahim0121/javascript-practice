...
// Math.random(ичине эчнерсе жазылбайт)
...
// let names =["Bakyt","Taalai","Myrza","Rolan"]
//
...
// b и результат присвойте переменной c. Затем создайте переменную d, присвойте ей значение.
